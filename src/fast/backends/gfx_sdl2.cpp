...
#ifdef __IOS__
    // ALLOW_HIGHDPI is essential: without it the Metal drawable is created at 1x point
    // scale (e.g. 932x430 on a 2796x1290 panel) and the game renders at 1/9th resolution.
